...
<body>
  ...
  <div class="container w-50 p-3 h-80">
    ...
    <div class="container w-50">
      <form id="loginForm">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="nombre"  aria-describedby="emailHelp" placeholder="Ingresa tu nombre completo">
        </div>
        <div class="form-group">
        ...
        <div class="text-center"><button id="btnSubmit" type="submit" class="btn azul-primario btn-block">Registrar</button></div>
      </form>
    </div>
  </div>
